            ...
            <ul>
                ...
                <li class="submenu">
                    ...
                    <ul style="display: none;">
                        ...
                        <li><a href="userguide.php"> Guide </a></li>
                ...
                <li class="submenu">
                    <a href="#"><i class="fe fe-map"></i> <span> Packages</span> <span class="menu-arrow"></span></a>
                    <ul style="display: none;">
                        <li><a href="packageadd.php"> Add Packages</a></li>
                        <li><a href="packageview.php"> View Packages </a></li>
                ...
                <li class="submenu">
                    <a href="#"><i class="fe fe-user"></i> <span> Booking </span> <span class="menu-arrow"></span></a>
                    <ul style="display: none;">
                        <li><a href="bookview.php"> View Booking </a></li>
                ...
                <li class="submenu">
                    <a href="#"><i class="fe fe-user"></i> <span> Shopping </span> <span class="menu-arrow"></span></a>
                    <ul style="display: none;">
                        <li><a href="shopingview.php"> View Order </a></li>
