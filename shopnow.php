...
if (isset($_POST['buy'])) {
    ...
    $sql = "insert into shopnow (name,phone,order_items,quantity,uid)
	values('$name','$phone','$order_items','$quantity','$uid')";
    $result = mysqli_query($con, $sql);
    if ($result) {
        $msg = "<p class='alert alert-success'>Your Order is Confirmed</p>";
    } else {
...
<head>
    ...
    <!--	Title
	=========================================================-->
    <title>Nep Yatra | Shop Now</title>
                        ...
                        <div class="loginbox">
                            <div class="login-right">
                                <div class="login-right-wrap">
                                    <h1>You Order</h1>
                                    <p class="account-subtitle">Get Tour Items</p>
                                    ...
                                    <form method="post" enctype="multipart/form-data">
                                        ...
                                        <button class="btn btn-success" name="buy" value="Buy Now" type="submit">Buy
                                            Now</button>
