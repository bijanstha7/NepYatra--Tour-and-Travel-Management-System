        ...
        <div class="row">
            ...
            <div class="banner-full-row page-banner" style="background-image:url('images/breadcromb.jpg');">
                <div class="container">
                    <div class="row">
                        <div class="col-md-6">
                            <h2 class="page-name float-left text-white text-uppercase mt-1 mb-0"><b>Filter Packages</b>
                            </h2>
                        </div>
                        <div class="col-md-6">
                            <nav aria-label="breadcrumb" class="float-left float-md-right">
                                <ol class="breadcrumb bg-transparent m-0 p-0">
                                    ...
                                    <li class="breadcrumb-item active">Filter Packages</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                        ...
                        <div class="col-lg-8">
                            <div class="row">
                                ...
                                if (isset($_REQUEST['filter'])) {
                                    ...
                                    $sql = "SELECT packages.*, user.uname FROM `packages`,`user` WHERE packages.uid=user.uid and type='{$type}' and stype='{$stype}' and city='{$city}'";
                                ...
                                <?php
                                        ...
                                        echo "<h1 class='mb-5'><center>No Packages Available</center></h1>";
                                    }
                                }
                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="sidebar-widget mt-5">
                                ...
                                <ul class="property_list_widget">
                                    ...
                                    <?php
                                    $query = mysqli_query($con, "SELECT * FROM `packages` ORDER BY date DESC LIMIT 6");
