...
<head>
    ...
    <!--	Title
	=========================================================-->
    <title>Nep Yatra | State Packages</title>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8">
                            <div class="row">
                                ...
                                $state = $_REQUEST['id'];
                                $query = mysqli_query($con, "SELECT packages.*, user.uname,user.utype,user.uimage FROM `packages`,`user` WHERE ppackages.uid=user.uid and state='$state'");
